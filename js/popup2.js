...
function popup1() {
    CreativaPopup.create('Feel free to DM me ! HighKey#1506', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">! HighKey#1506</font> or join my discord server <a href="https://discord.gg/spofer" style="color: #ADD8E6;">https://discord.gg/spofer</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("! HighKey#1506");
    setTimeout(function() {
